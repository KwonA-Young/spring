...
public class FusionRestaurant implements Restaurant {
    ...
    // 셰프
    // @Autowired // 컨테이너에 든 자료중 Chef에 대입할 수 있는 걸 자동으로 집어넣어라.
    // @Qualifier를 필드 주입에서 사용하는 경우는 @Autowired 다음줄에 @Qualifier를 작성해주시면 됩니다.
    private Chef chef;
    ...
    /// 세터 주입은 세터 위에 @Autowired 어노테이션을 붙여서 설정한다.
    // @Autowired
    ...
    @Autowired
    // 주입받을 파라미터 왼쪽에 @Qualifier("Bean이름) 을 입력하면, 지정 주입이 가능합니다.
